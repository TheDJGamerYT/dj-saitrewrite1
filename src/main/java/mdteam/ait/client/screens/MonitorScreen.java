...
public class MonitorScreen extends TardisScreen {
    ...
    private void createButtons() {
        ...
        this.addButton(new PressableTextWidget((width / 2 - 105), (height / 2 + 28), this.textRenderer.getWidth("exterior"), 10, Text.literal("exterior"), button -> TardisUtil.changeExteriorWithScreen(this.updateTardis().getUuid()), this.textRenderer));
    ...
    protected void drawDestinationText(DrawContext context) {
        ...
        if (this.updateTardis() == null) return;
