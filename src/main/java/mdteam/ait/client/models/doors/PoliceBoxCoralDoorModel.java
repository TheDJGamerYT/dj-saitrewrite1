...
public class PoliceBoxCoralDoorModel extends DoorModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData TARDIS = modelPartData.addChild("TARDIS", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 28.0F, 0.0F));

        ModelPartData Posts = TARDIS.addChild("Posts", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData phone = right_door.addChild("phone", ModelPartBuilder.create().uv(268, 37).cuboid(-3.75F, -40.0F, -13.5F, 2.0F, 3.0F, 2.0F, new Dilation(-0.3F))
                ...
                .uv(268, 43).cuboid(-3.75F, -37.75F, -13.5F, 2.0F, 3.0F, 2.0F, new Dilation(-0.5F))
                .uv(265, 25).cuboid(-8.5F, -40.0F, -13.5F, 5.0F, 6.0F, 2.0F, new Dilation(0.0F))
                .uv(268, 34).cuboid(-7.0F, -39.5F, -11.25F, 2.0F, 2.0F, 0.0F, new Dilation(0.0F))
                .uv(259, 35).cuboid(-5.5F, -42.0F, -13.5F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F))
                .uv(259, 35).cuboid(-8.5F, -42.0F, -13.5F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F))
                .uv(250, 35).cuboid(-5.5F, -42.0F, -13.5F, 2.0F, 2.0F, 2.0F, new Dilation(-0.2F))
        ...
        ModelPartData PCB = TARDIS.addChild("PCB", ModelPartBuilder.create().uv(241, 2).cuboid(-17.0F, -64.0F, -19.0F, 34.0F, 5.0F, 6.0F, new Dilation(0.0F))
