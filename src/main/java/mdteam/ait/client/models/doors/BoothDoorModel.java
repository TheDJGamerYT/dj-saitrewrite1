...
public class BoothDoorModel extends DoorModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData cube_r1 = Posts.addChild("cube_r1", ModelPartBuilder.create().uv(58, 103).cuboid(-9.0F, -36.0F, -8.0F, 2.0F, 34.0F, 2.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.0F, -1.5708F, 0.0F));

        ModelPartData Roof = k2.addChild("Roof", ModelPartBuilder.create().uv(106, 8).cuboid(-9.0F, -37.0F, -9.0F, 17.0F, 2.0F, 2.0F, new Dilation(0.0F))
