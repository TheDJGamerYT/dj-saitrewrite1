...
public class ToyotaDoorModel extends DoorModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData cube_r1 = Posts.addChild("cube_r1", ModelPartBuilder.create().uv(54, 78).cuboid(-18.0F, -65.0F, -18.0F, 4.0F, 61.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 10.0F, 0.0F, 3.1416F, 0.0F));

        ModelPartData cube_r2 = Posts.addChild("cube_r2", ModelPartBuilder.create().uv(71, 78).cuboid(-18.0F, -65.0F, -18.0F, 4.0F, 61.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.0F, 10.0F, 0.0F, 1.5708F, 0.0F));

        ModelPartData Doors = door.addChild("Doors", ModelPartBuilder.create(), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

        ModelPartData Left = Doors.addChild("Left", ModelPartBuilder.create().uv(0, 22).cuboid(0.5F, -29.5F, -0.5F, 13.0F, 55.0F, 1.0F, new Dilation(0.0F))
                .uv(58, 22).cuboid(0.5F, -29.5F, -1.0F, 14.0F, 55.0F, 0.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(9.5F, -9.5F, -1.5F, 1.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-13.5F, -29.5F, -5.5F));

        ModelPartData Right = Doors.addChild("Right", ModelPartBuilder.create().uv(29, 22).cuboid(-13.5F, -29.5F, -0.5F, 13.0F, 55.0F, 1.0F, new Dilation(0.0F))
                .uv(0, 10).cuboid(-12.5F, -10.5F, -1.5F, 1.0F, 4.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(13.5F, -29.5F, -5.5F));
        ...
        ModelPartData cube_r3 = PCB.addChild("cube_r3", ModelPartBuilder.create().uv(0, 10).cuboid(-17.0F, -61.0F, 13.0F, 34.0F, 5.0F, 6.0F, new Dilation(0.001F)), ModelTransform.of(0.0F, -3.0F, 10.0F, 0.0F, 3.1416F, 0.0F));
