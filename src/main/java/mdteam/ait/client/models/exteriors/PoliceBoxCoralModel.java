...
public class PoliceBoxCoralModel extends ExteriorModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData TARDIS = modelPartData.addChild("TARDIS", ModelPartBuilder.create().uv(0, 0).cuboid(-19.0F, -4.0F, -19.0F, 38.0F, 2.0F, 38.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 26.0F, 0.0F));
        ...
        ModelPartData Roof = TARDIS.addChild("Roof", ModelPartBuilder.create().uv(0, 43).cuboid(-16.0F, -68.0F, -16.0F, 32.0F, 4.0F, 32.0F, new Dilation(0.0F))
                ...
                .uv(0, 80).cuboid(-15.0F, -71.0F, -15.0F, 30.0F, 3.0F, 30.0F, new Dilation(0.0F))
                .uv(0, 0).cuboid(-3.0F, -73.0F, -3.0F, 6.0F, 2.0F, 6.0F, new Dilation(0.0F))
                .uv(-8, 18).cuboid(-4.0F, -77.0F, -4.0F, 8.0F, 0.0F, 8.0F, new Dilation(0.0F))
                .uv(-8, 18).cuboid(-4.0F, -74.0F, -4.0F, 8.0F, 0.0F, 8.0F, new Dilation(0.0F))
                .uv(0, 10).cuboid(-3.0F, -79.5F, -3.0F, 6.0F, 1.0F, 6.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -1.0F, 0.0F));

        ModelPartData cube_r7 = Roof.addChild("cube_r7", ModelPartBuilder.create().uv(14, 35).cuboid(0.0F, -72.75F, -3.5F, 0.0F, 6.0F, 7.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -6.25F, 0.0F, 0.0F, -0.7854F, 0.0F));

        ModelPartData cube_r8 = Roof.addChild("cube_r8", ModelPartBuilder.create().uv(14, 35).cuboid(0.0F, -72.75F, -3.5F, 0.0F, 6.0F, 7.0F, new Dilation(0.0F))
                .uv(0, 57).cuboid(-2.0F, -74.25F, -2.0F, 4.0F, 10.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -6.25F, 0.0F, 0.0F, 0.7854F, 0.0F));
