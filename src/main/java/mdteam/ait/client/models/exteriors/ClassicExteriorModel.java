...
public class ClassicExteriorModel extends ExteriorModel {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData classic = modelPartData.addChild("classic", ModelPartBuilder.create().uv(0, 0).cuboid(-18.0F, -2.0F, -18.0F, 36.0F, 2.0F, 36.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));

		ModelPartData Posts = classic.addChild("Posts", ModelPartBuilder.create().uv(29, 189).cuboid(-17.0F, -64.0F, -17.0F, 4.0F, 62.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, 0.0F, 0.0F));

		ModelPartData cube_r1 = Posts.addChild("cube_r1", ModelPartBuilder.create().uv(169, 153).cuboid(-18.0F, -66.0F, -18.0F, 4.0F, 62.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(1.0F, 2.0F, -1.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r2 = Posts.addChild("cube_r2", ModelPartBuilder.create().uv(177, 21).cuboid(-18.0F, -66.0F, -18.0F, 4.0F, 62.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 2.0F, -1.0F, 0.0F, 3.1416F, 0.0F));

		ModelPartData cube_r3 = Posts.addChild("cube_r3", ModelPartBuilder.create().uv(186, 153).cuboid(-17.0F, -66.0F, -18.0F, 4.0F, 62.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(-1.0F, 2.0F, 0.0F, 0.0F, -1.5708F, 0.0F));
		...
		ModelPartData cube_r4 = PCB.addChild("cube_r4", ModelPartBuilder.create().uv(203, 130).cuboid(-14.0F, -58.0F, -18.0F, 28.0F, 4.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		ModelPartData cube_r5 = PCB.addChild("cube_r5", ModelPartBuilder.create().uv(203, 138).cuboid(-14.0F, -58.0F, -18.0F, 28.0F, 4.0F, 3.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
